...
export const IMac:NextPage = () => {
  	return (
    		<div className="w-full relative h-screen overflow-hidden text-left text-base text-white font-open-sans">
      			...
      			<div className="absolute top-[702px] left-[863px]">Pas de compte ? Inscrivez-vous</div>
        				...
        				<div className="absolute top-[196px] left-[770px] w-[380px] h-[75px]">
          					...
          					<div className="absolute top-[43px] left-[12px] text-white">Saiissez votre adrese E-mail</div>
          					<div className="absolute top-[27px] left-[0px] rounded-8xs box-border w-[380px] h-12 border-[1px] border-solid border-gray-400" />
        				</div>
        				...
        				<div className="absolute top-[305px] left-[770px] w-[380px] h-[75px] text-gray-200 font-hind-madurai">
          					<div className="absolute top-[0px] left-[0px] w-[380px] h-[75px]">
            						<div className="absolute top-[43px] left-[12px] inline-block w-[59px] h-4">********
        				...
        				<div className="absolute top-[546px] left-[770px] w-[380px] h-12 text-gray-300">
          					<div className="absolute top-[13px] left-[129.61px] w-[195px] h-[22px]">
            						<div className="absolute top-[0px] left-[0px] font-semibold">Se connecter avec google</div>
          					</div>
